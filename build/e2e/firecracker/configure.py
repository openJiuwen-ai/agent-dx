...
if node=='node1':
 add('api','api-server',{'listen':'127.0.0.1:8888','loopback_http':True,'discovery':{'poll_seconds':1},'ca':str(T/'ca.pem'),'certificate':str(T/'api-server.pem'),'private_key':str(T/'api-server.key'),'server_name':'localhost','rpc_timeout_seconds':120,'cache_ttl_seconds':30,'cache_entries':1000,'auth_cache_ttl_seconds':10})
