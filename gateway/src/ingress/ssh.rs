...
/// Optional listener assembled by the shared standalone/embedded Ingress service.
...
impl SshListener {
    ...
    pub async fn bind(config: SshConfig, gateway: Arc<Ingress>) -> Result<Self> {
