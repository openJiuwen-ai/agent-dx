...
use adxlet::{readiness::ExecdReadiness, Readiness, RuntimeDriver};
...
fn checker(runtime: Arc<Runtime>, port: u16) -> ExecdReadiness {
    ExecdReadiness::new(
        runtime,
        port,
...
#[tokio::test]
async fn requires_runtime_and_valid_execd_response() {
